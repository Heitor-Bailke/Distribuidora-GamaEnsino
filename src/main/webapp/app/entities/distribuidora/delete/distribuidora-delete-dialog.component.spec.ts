...
describe('Distribuidora Management Delete Component', () => {
  let comp: DistribuidoraDeleteDialogComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [DistribuidoraDeleteDialogComponent],
      providers: [provideHttpClient(), NgbActiveModal],
    })
      .overrideTemplate(DistribuidoraDeleteDialogComponent, '')
      .compileComponents();
