...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'abc6b380-6c94-434b-a762-aa1a61b52666' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('aff47d40-e0d0-4b48-ad8c-d91d9fed57bd');
      cy.get(`[data-cy="name"]`).should('have.value', 'aff47d40-e0d0-4b48-ad8c-d91d9fed57bd');
